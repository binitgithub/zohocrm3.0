        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leads_Activities_AccountId",
                        column: x => x.AccountId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_Emails_EmailId",
                        column: x => x.EmailId,
                        principalTable: "Emails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_Quotes_QuoteId",
                        column: x => x.QuoteId,
                        principalTable: "Quotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leads_Tasks_ApptaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_EmailId",
                table: "Leads",
                column: "EmailId");

            migrationBuilder.CreateIndex(
                name: "IX_Leads_InvoiceId",
                table: "Leads",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Leads_QuoteId",
                table: "Leads",
                column: "QuoteId");
        }
